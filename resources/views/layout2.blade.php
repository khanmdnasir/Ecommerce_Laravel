					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
                                ...
                                @elseif(session()->get('user_name')!=NULL && session()->get('shipping_id')!=NULL)
								<li><a href="/payment"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                @else
								<li><a href="/login_check"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                @endif
								<li><a href="/show_cart"><i class="fa fa-shopping-cart"></i> Cart<span style="color: red">{{Cart::count()}}</span></a></li>
                                @if(session()->get('user_name'))
								<li><a href="/user_logout"><i class="fa fa-lock"></i> Logout</a></li>
                                @else
								<li><a href="/login_popup"><i class="fa fa-lock"></i> Login</a></li>
                                @endif
							</ul>
						</div>
					</div>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="shop">Track Order</a></li>
										<li><a href="product-details">Sell Products</a></li>
										@if(session()->get('user_name')!=NULL && session()->get('shipping_id')==NULL)
								<li><a href="/checkout"><i class="fa fa-crosshairs"></i> Checkout</a></li>
                                @elseif(session()->get('user_name')!=NULL && session()->get('shipping_id')!=NULL)
								<li><a href="/payment"><i class="fa fa-crosshairs"></i> Checkout</a></li>
